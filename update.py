...
update_script = "-m aideadlines.update_data"  # os.path.join(this_dir, "src", "update_data.py")
...
to_json_script = "-m aideadlines.data_to_json"  # os.path.join(this_dir, "src", "data_to_json.py")
